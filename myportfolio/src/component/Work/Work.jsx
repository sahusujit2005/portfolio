...
//               w-[80%] max-w-2xl       /* 👈 WIDTH REDUCED HERE */
...
//                 <h3 className="lg:text-3xl text-xl font-bold text-white mb-4">
...
//                     <span
//                       key={index}
//                       className="bg-[#251f38] text-sm font-semibold text-purple-500 rounded-full px-2 py-1"
//                     >
//                       {tag}
//                     </span>
//                   ))}
...
//                     className="
//                       w-1/2 bg-gray-800 hover:bg-purple-800 
//                       text-gray-300 lg:px-6 lg:py-2 px-2 py-1 
      ...
      {selectedProject && (
        <div
          className="
            ...
            pt-[80px]      /* 👈 Navbar ke neeche space */
            p-4 overflow-y-auto
          "
        >
          <div

...
//     <section
//       id="experience"
//       className="py-24 pb-24 px-[12vm] ms:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient"
//     >
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Card */}
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl border border-white 

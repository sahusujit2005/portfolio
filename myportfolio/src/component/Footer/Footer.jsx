...
function Footer() {
  const handleScroll =(sectionId)=>{const section = document.getElementById(sectionId);
    if(section){
  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        <h2 className="text-xl font-semibold text-purple-500">Sujeet sahu</h2>
        ...
        <p className='text-sm text-gray-400 mt-6'>Sujeet sahu. All rights reserved</p>
      </div>
    </footer>
  );
}
